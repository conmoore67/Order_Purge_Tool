...
$form.Size = New-Object System.Drawing.Size(320, 500)  # Increased form height
$form.StartPosition = 'CenterScreen'
...
$bannerLabel.Size = New-Object System.Drawing.Size(300, 20)
...
$labelMoveNumber.Location = New-Object System.Drawing.Point(10, 40)
$labelMoveNumber.Size = New-Object System.Drawing.Size(280, 20)
...
$textboxMoveNumber.Location = New-Object System.Drawing.Point(10, 70)
$textboxMoveNumber.Size = New-Object System.Drawing.Size(290, 20)
...
$labelConfirmMoveNumber.Location = New-Object System.Drawing.Point(10, 100)
$labelConfirmMoveNumber.Size = New-Object System.Drawing.Size(280, 20)
...
$textboxConfirmMoveNumber.Location = New-Object System.Drawing.Point(10, 130)
$textboxConfirmMoveNumber.Size = New-Object System.Drawing.Size(290, 20)
...
$pictureBox.SizeMode = 'Zoom'  # Changed to Zoom mode for better scaling
$pictureBox.Location = New-Object System.Drawing.Point(10, 190)  # Moved down to prevent obstruction
$pictureBox.Size = New-Object System.Drawing.Size(290, 100)  # Adjusted size
...
$okButton.Add_Click({
    if ($textboxMoveNumber.Text -eq $textboxConfirmMoveNumber.Text) {
        $confirmation = [System.Windows.Forms.MessageBox]::Show("Do you really want to proceed with the purge for Move Number: $($textboxMoveNumber.Text)? Please verify within TMW to ensure that the correct move number is targeted for purging, as this will prevent the accidental purging of active orders.", "Confirm", [System.Windows.Forms.MessageBoxButtons]::YesNo)
...
if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    # (Add your logic here to process the confirmed move number)
    # ... Rest of your script for confirmation form
}
...
$labelDescription.Size = New-Object System.Drawing.Size(380, 150)  # Adjust the size as needed
...
$okButton = New-Object System.Windows.Forms.Button
$okButton.Location = New-Object System.Drawing.Point(150, 210)  # Position the button
$okButton.Size = New-Object System.Drawing.Size(100, 23)
$okButton.Text = "OK"
